export const translations = {
  ar: {
    ...
    testimonials: {
      ...
      testimonial1Quote: "شغلهم مع جزل كان روعة، وطلعو لنا فعالية فوق المتوقع.",
    ...
    footer: {
        ...
        links: "روابط سريعة",
        follow: "تابعنا",
        rights: "جميع الحقوق محفوظة لـ جزل © 2025 ROQI تصميم وتطوير",
        companyTitle: "شركتنا",
  ...
  en: {
    ...
    footer: {
        ...
        links: "Quick Links",
        follow: "Follow Us",
        rights: "All rights reserved to Jazal © 2025 ROQI Design & Development",
